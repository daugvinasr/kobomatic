...
func (app *App) GetInitialization(c echo.Context) error {
	return c.JSON(http.StatusOK, echo.Map{
		"Resources": echo.Map{
			...
			"store_host":                       "https://kobo.com",
			"store_home":                       "https://kobo.com/{region}/{language}",
			...
			"image_host":                       app.env.ServerAddress,
			"image_url_template":               app.env.ServerAddress + "/v1/book-images/{ImageId}/{Width}/{Height}/false/image.jpg",
			"image_url_quality_template":       app.env.ServerAddress + "/v1/book-images/{ImageId}/{Width}/{Height}/{Quality}/{IsGreyscale}/image.jpg",
